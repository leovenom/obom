  ...
  useEffect(() => {
    fetch('/api/auth/providers')
      ...
      .then((data) => {
        ...
        setGoogleMessage(data.message || null);
      })
  ...
  return (
    <section className="screen active auth-screen">
      ...
      <p className="subtitle">
        {mode === 'login'
          ? 'Faça login para enviar sua captura'
          : 'Crie sua conta para enviar capturas'}
      </p>
      ...
      {!googleEnabled && googleMessage && (
        <p className="google-unavailable">{googleMessage}</p>
      )}
        ...
        <button className="btn btn-primary" type="submit" disabled={loading || googleLoading}>
          {loading ? (
            ...
            <>
              ...
              {mode === 'login' ? 'Entrar com e-mail' : 'Cadastrar'}
            </>
          )}
        </button>
      </form>
